...
4. 保持以下约束不变，除非用户明确要求修改：
   ...
   - `今日運勢` 详情页复用首页卡片核心内容；`心靈樹洞` 展示 5-10 条匿名心情发言；`塔羅測算` 随机展示一张塔罗牌和一条最近感情运势走向
  ...
  - `十二星座` Banner 不应继续走通用详情页，应拆成专门的星座人格介绍页，集中展示 12 星座的人格特质介绍；陪伴页中其下方还应补充 `十二生肖人格地圖` 入口，并进入独立生肖人格介绍页
...
- 至少校验首页与陪伴页的 `十二星座` Banner 已接到独立的星座人格详情 Activity，且陪伴页已增加独立的 `十二生肖人格地圖` 入口与详情 Activity
